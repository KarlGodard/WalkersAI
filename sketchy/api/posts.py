...
@sketchy.app.route("/api/v1/posts/")
...
@sketchy.app.route("/api/v1/posts/<int:postid_url_slug>/")
...
@sketchy.app.route("/api/v1/likes/", methods=["POST"])
def like_post():
    """Like post."""
    connection = sketchy.model.get_db()
    logname = login(connection)
...
@sketchy.app.route("/api/v1/likes/<int:likeid>/", methods=["DELETE"])
...
@sketchy.app.route("/api/v1/comments/", methods=["POST"])
def comment_post():
    """Comment post."""
    connection = sketchy.model.get_db()
    logname = login(connection)
...
@sketchy.app.route("/api/v1/comments/<int:commentid>/", methods=["DELETE"])
